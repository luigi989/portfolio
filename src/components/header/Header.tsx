...
const Header = ({ visibilityRef, snap }: HeaderProps) => {
  ...
  return (
    <header
      ...
      className={
        snap +
        " h-fit md:h-[68vh] lg:h-screen w-3/4 m-auto pt-16 overflow-hidden print:h-screen"
      }
    >
      <div className="h-full w-11/12 md:w-3/4 m-auto text-center relative text-liSec dark:text-white">
        <div className="p-1 flex flex-col bg-liBg dark:bg-transparent w-fit m-auto">
          <h1 className="mb-3 text-center text-liLight dark:text-light font-medium text-3xl">
            {t("header.title")}
          </h1>
          <h2 className="text-center text-liSec dark:text-primaryAlt font-medium text-2xl">
            {t("header.subtitle")}
          </h2>
        </div>
        ...
        <div
          className="hidden lg:flex flex-col items-center gap-3 absolute left-0 bottom-12 bg-liBg p-1 dark:bg-transparent
        ...
        <div
          className="bg-gradient-to-b from-liSec dark:from-primaryAlt lg:w-2/6 w-3/4 h-4/6 mt-16 
